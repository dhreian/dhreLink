...
formato y un estado conectado calculado a partir del heartbeat real de OBS. La
las fuentes Quintessential y Montserrat se cargan desde recursos incrustados en el binario
mientras la vista está abierta; no se registra en Windows.
