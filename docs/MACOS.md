...
OBS en Mac. Se publica como beta 0.1.0 sin validación de audio de extremo a extremo en Mac.
...
El workflow de `main` construye ambos componentes y prepara un `.pkg` sin
...
La beta se puede publicar con esta limitación explícita. Una versión estable
debe esperar a que el emisor y el receptor funcionen juntos en un Mac con un
DAW y OBS.
